describe('I should be able to save upcoming events delete them', () => {
  ...
  it.only('Should be able to click on a button to save and delete events and be notified if there are no saved events when on the page to view events, should be able to delete from the saved events pages and also be able to click on an event to view more details from the saved events page.', () => {
    cy.wait('@upcoming-events').then(() => {
